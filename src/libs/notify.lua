 ...
 * ======================================================================== *
 * ?                                ABOUT
 * @title          :  libs/notify.lua
 * @credits        :  xlISInner/NotificationsLibrary
 * ======================================================================== *
--]]
...
Container.ImageColor3 = Color3.fromRGB(21,22,23)
Container.ImageTransparency = 0.1
...
Top.ImageColor3 = Color3.fromRGB(211, 175, 56)
...
function lib(title, description, closeTime)
